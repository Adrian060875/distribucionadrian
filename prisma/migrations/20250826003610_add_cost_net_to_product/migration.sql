...
INSERT INTO "new_Product" ("cashPrice", "createdAt", "description", "id", "isActive", "listPrice", "name", "sku", "updatedAt") SELECT "cashPrice", "createdAt", "description", "id", "isActive", "listPrice", "name", "sku", "updatedAt" FROM "Product";
DROP TABLE "Product";
