 ...
 * Resumen por alianza:
 *  - commissionDue: suma de comisiones adeudadas por lo cobrado (anticipo + pagos), tope base sin interés
...
export async function GET() {
  try {
    ...
    // Traemos las órdenes por alianza con lo necesario para calcular
